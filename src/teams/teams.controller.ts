...
export class TeamsController {
  ...
  accept(
    ...
    return this.teams.acceptMember(token, user.id, memberId);
  }
  ...
  setRole(
    ...
    assertUuid(memberId, 'member id');
    return this.teams.setMemberRole(token, user.id, memberId, dto.role);
  }
  ...
  removeMember(
    ...
    assertUuid(memberId, 'member id');
    return this.teams.removeMember(token, user.id, memberId);
  }
  ...
  transfer(
    ...
    assertUuid(id, 'team id');
    return this.teams.transferOwner(token, user.id, id, dto.new_owner);
  }
  ...
  remove(
    ...
    assertUuid(id, 'team id');
    return this.teams.delete(token, user.id, id);
  }
}
